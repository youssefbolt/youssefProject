...
<html>
    ...
    <header id="gtco-header"  role="banner" style="background-image: url(img_2.jpg)" data-stellar-background-ratio="0.5">
...
{{ $ncnb->text }}
 ...
 <video width="400" height="300" controls>
  <source src="{{asset(''.$ncnb->video)}}" type="video/mp4">
    ...
    <footer id="gtco-footer" role="contentinfo" style="background-image:url('{{asset('z.png')}}');" data-stellar-background-ratio="0.5" >
