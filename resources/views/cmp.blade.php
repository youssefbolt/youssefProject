...
<img src="{{asset('ville.jpg')}}" class="img-circle" height="42" width="42"> {{$ncnb->ville}}
 ...
 <center><p><a href="{{url('cmpedite/'.$ncnb->id)}}" class="btn btn-info" role="button">Modifier</a> <a href="{{url('cmpdeletevalidation/'.$ncnb->id)}}" role="button" class="btn btn-danger">Supprimer </a></p>
 {{$ncnb->created_at}}
