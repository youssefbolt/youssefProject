...
<html>
    ...
    <header id="gtco-header" role="banner" 
     ...
     style="background-image:url('{{asset('z.png')}}') ;" data-stellar-background-ratio="0.5">
                ...
                <div class="col-md-12 col-md-offset-0 text-left">
                    ...
                    <div class="row row-mt-15em">
                        <div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
                            ...
                            <h1 class="cursive-font">  Vous n'êtes pas seul  nous somme tous avec vous..!</h1>    
                        </div>
...
{{session()->get('ss')}} @endif
                                    <div class="tab-content">
                                        <div class="tab-content-inner active" data-content="signup">
                                            <h3 class="cursive-font">Accédez  à votre compte (Bénéficiaire)  </h3>
                                            <form method="POST" action="{{ url('login') }}">
                        @csrf

                        <div class="form-group row " >
                            <label for="email" class="col-sm-4 col-form-label text-md-right"><strong> E-Mail </strong></label>
                        ...
                        <div class="form-group row">
   <label for="password" class="col-md-4 col-form-label text-md-right"><strong> Mot de   passe  </strong></label>
        ...
        <div class="gtco-container">
            <div class="row">
                <div class="col-md-12 col-md-offset-0 text-left" >
                    ...
                    <div class="row row-mt-15em" style="margin-top: 6%;">
                        <div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
                            <span class="intro-text-small"> <a href="http://gettemplates.co" target="_blank"></a></span>
                            <h1 class="cursive-font">Votre aide coûte chère pour les gens au-dessus</h1>    
                        </div>
                        <div class="col-md-4 col-md-push-1 animate-box" data-animate-effect="fadeInRight" style="width: 40%;">
                            <div class="form-wrap">
                                <div class="tab">
...
{{session()->get('ss')}} @endif
                                    <div class="tab-content">
                                        <div class="tab-content-inner active" data-content="signup">
                                            <h3 class="cursive-font">Accédez  à votre compte (Bénévole)</h3>
                                          
                        @csrf
 <form class="form-horizontal" role="form" method="POST" action="{{ url('/bini/login') }}">
                        {{ csrf_field() }}
...
<a class="btn btn-link" href="{{ url('register') }}">
 ...
 Mot de passe Oublié ?
    ...
    <footer id="gtco-footer" role="contentinfo"  style="background-image:url('{{asset('z.png')}}');" data-stellar-background-ratio="0.1" >
        <div class="overlay" ></div>
