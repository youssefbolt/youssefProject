...
<html>
                                ...
                                <div class="tab">
                                    ...
                                    <div class="tab-content">
                                        <div class="tab-content-inner active" data-content="signup">
                                            <h3 class="cursive-font">Entrez Votre Informations</h3>
  ...
  <input type="radio" name="sex" value="female"> Femme
                        ...
                        <div class="form-group row">
                            <label for="radem_u" class="col-md-4 col-form-label text-md-right">Id-Ramed</label>
             ...
             <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              ...
                              <div class="form-group row">
                            <label for="dateN" class="col-md-4 col-form-label text-md-right">Date de Naissance </label>
