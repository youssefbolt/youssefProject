...
<div class="panel panel-default" style="float:left; width: 90%;" height="420" width="420">
  <div class="panel-heading" ><strong> texte</strong> </div>
  <div class="panel-body" style="width: 700px ; word-wrap: break-word;" >

   <center> <img src="{{asset($ncnb->photo_cmp)}}"  style="
...
<img src="{{asset('ville.jpg')}}" class="img-circle" height="42" width="42"> {{$ncnb->ville}}
 ...
 <center><p><a href="{{url('cmpedite/'.$ncnb->id)}}" class="btn btn-info" role="button">UPDATE</a> <a href="{{url('cmpdeletevalidation/'.$ncnb->id)}}" role="button" class="btn btn-danger">DELETE {{$ncnb->id}}</a></p>
 {{$ncnb->created_at}}
