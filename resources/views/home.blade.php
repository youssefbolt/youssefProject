          ...
          <li class="has-dropdown">
                            ...
                            <ul class="dropdown">
                                ...
                                <li><a href="/cmpcreate">Organiser une Campagne</a></li>
                                 <li><a href="/create">Postez une Anoonce </a></li>
                            </ul>
                        </li>
...
<a href="{{url('watch/'.$ncnb->id)}}"><img src="{{asset('Video.jpg')}}" class="img-circle" height="200" width="50"></a>@endif
 ...
 <center><p><a href="{{url('edite/'.$ncnb->id)}}" class="btn btn-info" role="button">Modifier</a> <a href="{{url('deletevalidation/'.$ncnb->id)}}" role="button" class="btn btn-danger">Supprimer</a></p>
 {{$ncnb->created_at}}
