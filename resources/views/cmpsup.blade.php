...
<img src="{{asset('ville.jpg')}}" class="img-circle" height="42" width="42"> {{$ncnb->ville}}
 ...
 <center><p><a href="{{url('cmp')}}" class="btn btn-info" role="button">Annuler</a> <a href="{{url('/cmpdelete/'.$ncnb->id)}}" role="button" class="btn btn-danger">Vous êtes sûre de supprimé cette annonce </a></p>
 {{$ncnb->created_at}}
