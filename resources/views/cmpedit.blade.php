...
<div class="container">
  ...
  <div class="panel panel-default " style="margin-top: 20%;">
    <div class="panel-body">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('cmpupdate/'.$ncnb->id) }}" enctype="multipart/form-data">
                        @csrf
</br>
...
{{ $ncnb->text }}
                        ...
                        <div class="form-group row">
                            <label for="type_cmp" class="col-md-4 col-form-label text-md-right">type_</label>

                            <div class="col-md-6">
                           <select name="type_cmp">
  <option value="{{$ncnb->type_cmp}}">{{$ncnb->type_cmp}}</option>
 ...
 <img src="{{asset($ncnb->photo_cmp)}}"  style="
       float:left;"  height="150" width="150">
                        ...
                        </div><center>  <input type="file" name="photo_cmp"></center>
