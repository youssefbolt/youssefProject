...
<html>
    ...
    <header id="gtco-header"  role="banner" style="background-image: url(ff.png)" data-stellar-background-ratio="0.5">
...
<div class="container " >
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card card-default">
                ...
                <div class="panel panel-default"  style="margin-left: 100px; margin-right: 20px; margin-top: 200px;">
  <div class="panel-heading"><strong>  <img src="{{asset('create.jpg')}}"  height="50" width="40"> Creez  une Campagne</strong></div>
  <div class="panel-body">
    
                <div class="card-header"></div>

                <div class="card-body">
                    <form method="POST" action="{{ url('cmpstore') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row">
                            <label for="text" class="col-md-4 col-form-label text-md-right">Texte</label>
                        ...
                        <div class="form-group row">
                            <label for="type_cnb" class="col-md-4 col-form-label text-md-right">Type de Campagne </label>

                            <div class="col-md-6">
                           <select name="type_cmp">
  ...
  <option value="casa">casablanca</option>
                                        ...
                                        <div class="form-group row">
                            <label for="type_cnb" class="col-md-4 col-form-label text-md-right">Ville</label>
  ...
  <div class="form-group row">
            ...
            <input type="file" name="photo_cmp" >
 </div>
                        </div>
        ...
        <div class="gtco-container"    ">
            <div class="row row-pb-md">
                ...
                <div class="col-md-12 text-center copyright">
                    <p><small class="block">&copy; 2018 Tous les droits réservés.</small> 
