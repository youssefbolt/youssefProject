...
<div class="container" style="margin-top: 0%;" >
 <center>
  <div  style="width: 40%; margin-top: 10%;" class="panel panel-primary" >
...
<a href="{{url('watch/'.$ncnb->id)}}"><img src="{{asset('Video.jpg')}}" class="img-circle" height="200" width="50"></a>@endif
 ...
 <center><p><a href="{{url('edite/'.$ncnb->id)}}" class="btn btn-info" role="button">UPDATE</a> <a1 href="{{url('deletevalidation/'.$ncnb->id)}}" role="button" class="btn btn-danger">DELETE {{$ncnb->id}}</a1></p>
 {{$ncnb->created_at}}
