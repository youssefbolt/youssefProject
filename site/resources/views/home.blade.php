...
<div class="container" style="margin-top: 0%;" >
  ...
  <div  style="width: 70%; margin-top: 10%; margin-left: 0%;" class="panel panel-primary" >
...
<div class="fb-share-button"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">مشاركة</a></div>
 ...
 <a id=<?php echo $ncnb->id; ?> ></a>
      ...
      <div >
<center>
        <img src="{{asset($nuser->photo_user)}}" class="img-circle" height="42" width="42"> 

        <strong>{{$nuser->name}}      </strong>         
     </div> </center>
...
Le substantif « automobile » est attesté vers 1890, mais son genre, aujourd'hui seulement féminin, est longtemps resté pour les linguistes un sujet ouvert3. L'Académie française s'est prononcée dès 1901 pour le genre féminin4, mais la polémique ne s'est éteinte que bien après, le masculin étant attesté ponctuellement jusqu'en 19443.
     ...
     <div class="panel-footer"> <img src="{{asset('email.jpg')}}" class="img-circle" height="42" width="42"> {{$nuser->email}} 
<img src="{{asset('tele.jpg')}}" class="img-circle" height="42" width="42"> {{$nuser->tel}} 
<img src="{{asset('ville.jpg')}}" class="img-circle" height="42" width="42"> {{$nuser->ville}}
...
<a href="{{url('watch/'.$ncnb->id)}}"><img src="{{asset('Video.jpg')}}" class="img-circle" height="200" width="50"></a>@endif
 ...
 <center><p><a href="{{url('edite/'.$ncnb->id)}}" class="btn btn-info" role="button">UPDATE</a> <a href="{{url('deletevalidation/'.$ncnb->id)}}" role="button" class="btn btn-danger">DELETE {{$ncnb->id}}</a></p>
 {{$ncnb->created_at}}
